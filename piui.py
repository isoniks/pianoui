...
oled.activeSong = 'http://' + os.uname()[1] + '.local'
oled.activeArtist = 'Start the music on'
...
class NowPlayingScreen():
	...
	self.icon = {'play':'\u25B6', 'pause':'\u2389', 'stop':'\u25A0'}       	    #entypo icons
        ...
        self.text1Pos = (30, 2)        #Artist /
        self.text2Pos = (30, 27)       #Title
        self.text3Pos = (30, 4)        #clock
        self.text4Pos = (34, 54)       #IP
        self.text5Pos = (182, 54)      #Date
        self.text6Pos = (30, 52)       #format
...
# "def DrawON(..." takes informations from above and creates a "picture" which then is transfered to your display	
	...
	iconwidth, iconheight = drawalfa.textsize(self.playingIcon, font=self.iconfont)            #entypo
        left = (self.width - iconwidth + 30) / 2						   #here is defined where the play/pause/stop icons are displayed. 
